-- Migration 001: Initial schema (v1 base)
-- Contains all tables and objects that existed before migration 002.
-- Replaying 001 through 006 on an empty DB produces the current schema.
